...
<div class="Newsletter">
  ...
  <form
    action="https://tinyletter.com/juanpabloceliz"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/juanpabloceliz', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true">
    <p><label for="tlemail">Ingresa tu email</label></p>
